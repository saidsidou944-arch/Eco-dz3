...
import { Store, ArrowRight, Mail, Lock, User, Facebook } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#F4F5F7] flex items-center justify-center p-4 font-sans">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 mt-2 font-medium">Join the Algerian e-commerce revolution.</p>
        </div>
